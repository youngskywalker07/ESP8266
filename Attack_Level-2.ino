...
MDNSResponder mdns;
const char* ssid = "skywalker"; // your connection name
const char* password = "nomnom11"; // your connection password
ESP8266WebServer server(80);
int gpio1_pin = D1;  // D1 of nodemcu
int gpio2_pin = D2; // D2 of nodemcu
int gpio3_pin =D5; //  D5 of nodemcu
